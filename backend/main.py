...
# ------------------------------
    ...
    try:
        ...
        logger.info("🎙️  Loading WavLM Base+ + DeepFakeDetector at startup...")
        load_audio_models()
        logger.info("✅ Audio models (WavLM + classifier) loaded successfully.")
    except Exception as e:
        # Non-fatal — server continues; audio endpoint will fail gracefully
...
from api.audio.routes import router as audio_router  # REST-only audio endpoint

app.include_router(video_ws_router)
app.include_router(video_router)
app.include_router(auth_router)
app.include_router(audio_router)  # POST /audio/analyze — synchronous REST
